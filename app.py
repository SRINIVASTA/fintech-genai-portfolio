...
# 2. Premium Custom CSS Styling (No raw HTML wrappers, no white box glitches)
st.markdown("""
    <style>
    /* Main profile frame block */
    .main-profile-card {
    ...
    .profile-title { color: #0f172a; font-size: 28px; font-weight: 700; margin-bottom: 4px; }
...
# 3. Native Streamlit Layout Setup (Guarantees zero rendering bugs)
...
# NOTE: Change this placeholder URL to your actual Streamlit link once it goes live!
...
with display_col2:
    st.write("Open this app on your smartphone or monitor at technical meetups in Visakhapatnam. Anyone who scans this QR code will load your complete operational suite on their device.")
